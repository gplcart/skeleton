  ...
  <div class="row">
        ...
        <div class="panel-body">
          ...
          <div class="form-group">
            ...
            <div class="col-md-9">
              ...
              <div class="help-block">
                  <?php echo $this->text('Choose a license to be shown in the module DocBlock'); ?>
              </div>
            </div>
          </div>
          <div class="form-group<?php echo $this->error('module.author', ' has-error'); ?>">
            <label class="col-md-3 control-label">
                <?php echo $this->text('Author'); ?>
            </label>
            <div class="col-md-9">
              <input maxlength="255" name="skeleton[module][author]" class="form-control" value="<?php echo isset($skeleton['module']['author']) ? $this->escape($skeleton['module']['author']) : ''; ?>">
              <div class="help-block">
                  <?php echo $this->error('module.author'); ?>
                <div class="text-muted">
                    <?php echo $this->text('An author name to shown in the module info and DocBlock'); ?>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="col-md-6">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <p><?php echo $this->text('Extra options to setup your module the best way. Although there\'s no strict requirements on how to organize your classes, it\'s recommended to follow common rules'); ?></p>
          <div class="checkbox">
            <label>
              <input type="checkbox" value="1" name="skeleton[structure][controllers]"<?php echo empty($skeleton['structure']['controllers']) ? '' : ' checked'; ?>> <?php echo $this->text('Create sample controller'); ?>
            </label>
          ...
          <div class="checkbox">
            <label>
              <input type="checkbox" value="1" name="skeleton[structure][helpers]"<?php echo empty($skeleton['structure']['helpers']) ? '' : ' checked'; ?>> <?php echo $this->text('Create sample helper'); ?>
            </label>
            <div class="help-block"><?php echo $this->text('Helper classes provide independent reusable methods to be used everywhere'); ?></div>
          </div>
          <div class="checkbox">
            <label>
              <input type="checkbox" value="1" name="skeleton[structure][handlers]"<?php echo empty($skeleton['structure']['handlers']) ? '' : ' checked'; ?>> <?php echo $this->text('Create sample handler'); ?>
            </label>
          ...
          <div class="checkbox">
            <label>
              <input type="checkbox" value="1" name="skeleton[structure][templates]"<?php echo empty($skeleton['structure']['templates']) ? '' : ' checked'; ?>> <?php echo $this->text('Create sample template'); ?>
            </label>
            <div class="help-block"><?php echo $this->text('Templates display various data from controllers to users'); ?></div>
          </div>
          <div class="checkbox">
            <label>
              <input type="checkbox" value="1" name="skeleton[structure][models]"<?php echo empty($skeleton['structure']['models']) ? '' : ' checked'; ?>> <?php echo $this->text('Create sample model'); ?>
            </label>
            <div class="help-block"><?php echo $this->text('Models provide a business logic and can interact with database'); ?></div>
          </div>
          <div class="checkbox">
            <label>
              <input type="checkbox" value="1" name="skeleton[structure][override]"<?php echo empty($skeleton['structure']['override']) ? '' : ' checked'; ?>> <?php echo $this->text('Create sample overridden method'); ?>
            </label>
